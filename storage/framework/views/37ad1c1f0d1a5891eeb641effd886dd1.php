...
<?php $component->withAttributes(['align' => 'right','width' => '56']); ?>
                 <?php $__env->slot('trigger', null, []); ?> 
                    <button class="flex items-center p-1 rounded-full hover:bg-gray-100 transition-all duration-200 focus:outline-none">
                        ...
                        <div class="hidden md:flex flex-col items-start ml-2 mr-1">
                            <span class="text-sm font-semibold text-gray-700 leading-none"><?php echo e(Auth::user()->name); ?></span>
                 ...
                 <?php $__env->slot('content', null, []); ?> 
                    <div class="px-4 py-2 border-b border-gray-100 bg-gray-50/50 rounded-t-md">
                        ...
                        <p class="text-sm font-medium text-gray-800 truncate"><?php echo e(Auth::user()->email); ?></p>
                    </div>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('logout')),'class' => 'rounded-md flex items-center gap-2 text-red-600 hover:bg-red-50 hover:text-red-700','onclick' => 'event.preventDefault(); this.closest(\'form\').submit();']); ?>
