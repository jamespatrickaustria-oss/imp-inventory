      ...
      <div class="p-1.5 min-w-full inline-block align-middle">
        <div class="border rounded-xl shadow-sm overflow-hidden bg-white border-gray-200 dark:bg-dark-surface-secondary dark:border-dark-700">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-dark-surface-tertiary transition-colors">
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center gap-x-2">
                      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($category['image_path']): ?>
                        <img src="<?php echo e(asset('storage/' . $category['image_path'])); ?>" alt="<?php echo e($category['name']); ?>" class="size-7 rounded-md object-cover">
                      <?php else: ?>
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showArchived): ?>
                      <button 
                        wire:click="restoreCategory(<?php echo e($category['id']); ?>)"
                        class="text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300 font-semibold px-2">
                        Restore
                      </button>
                      <button 
                        wire:click="permanentDeleteCategory(<?php echo e($category['id']); ?>)"
          ...
          <div class="px-6 py-4 border-t border-gray-200 flex justify-between items-center dark:border-dark-700">
            <span class="text-sm text-gray-600 dark:text-gray-400"><?php echo e(count($categories)); ?> categories total</span>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="space-y-4">
          <div>
            ...
            <input 
              type="text" 
              wire:model="name"
              class="py-2.5 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 shadow-sm dark:border-dark-600 dark:bg-dark-surface-tertiary dark:text-gray-100 dark:placeholder-gray-500 dark:focus:border-blue-400 <?php $__errorArgs = ['name'];
          ...
          <div>
            ...
            <div class="flex rounded-lg shadow-sm">
              ...
              <input 
                type="text" 
                wire:model="slug"
                class="py-2.5 px-4 block w-full border-gray-200 shadow-sm rounded-e-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:border-dark-600 dark:bg-dark-surface-tertiary dark:text-gray-100 dark:placeholder-gray-500 dark:focus:border-blue-400 <?php $__errorArgs = ['slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
  ...
  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewingCategoryId): ?>
    <div class="fixed inset-0 z-[90] overflow-y-auto bg-gray-900/50 backdrop-blur-sm flex items-center justify-center p-4">
      <div class="bg-white border shadow-sm rounded-xl w-full max-w-4xl overflow-hidden transition-all dark:bg-dark-surface-secondary dark:border-dark-700">
        ...
        <div class="p-4 sm:p-6 overflow-y-auto max-h-[70vh]">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($viewingCategoryProducts) > 0): ?>
            <div class="overflow-x-auto">
              <table class="min-w-full divide-y divide-gray-200 dark:divide-dark-700">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-dark-700">
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $viewingCategoryProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-gray-50 dark:hover:bg-dark-surface-tertiary">
                      <td class="px-4 py-3 whitespace-nowrap">
                        <div class="flex items-center gap-x-2">
                          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product['image_path']): ?>
                            <img src="<?php echo e(asset('storage/' . $product['image_path'])); ?>" alt="<?php echo e($product['name']); ?>" class="h-8 w-8 rounded object-cover">
                          <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                      ...
                      <td class="px-4 py-3 whitespace-nowrap">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product['quantity'] <= $product['min_stock']): ?>
...
</div><?php /**PATH C:\Users\Dell\StockMaster-Pro\resources\views/livewire/pages/admin/category-index.blade.php ENDPATH**/ ?>