<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6">
  ...
  <div class="group flex flex-col bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-md transition-all duration-300">
    <div class="p-5">
      ...
      <div class="mt-3 flex items-end justify-between">
        <div>
          <h3 class="text-2xl font-bold text-gray-900 leading-none"><?php echo e($totoalProducts); ?></h3>
  ...
  <div class="group flex flex-col bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-md transition-all duration-300">
    <div class="p-5">
      ...
      <div class="mt-3">
        <h3 class="text-2xl font-bold text-gray-900 leading-none"><?php echo e($totalCategories); ?></h3>
  ...
  <div class="group flex flex-col bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-md transition-all duration-300">
    <div class="p-5">
      ...
      <div class="mt-3 flex items-end justify-between">
        <div>
          <h3 class="text-2xl font-bold text-gray-900 leading-none"><?php echo e($totalLowstock); ?></h3>
  ...
  <div class="group flex flex-col bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-md transition-all duration-300">
    <div class="p-5">
      ...
      <div class="mt-3">
        <h3 class="text-2xl font-bold text-gray-900 leading-none"><?php echo e('$ ' . $getRevenue); ?></h3>
        <p class="mt-2 text-sm text-gray-500">Last 30 days</p>
      </div>
    </div>
  </div>

</div><?php /**PATH C:\Users\Dell\StockMaster-Pro\StockMaster-Pro\resources\views\livewire\pages\admin\partials\kpis.blade.php ENDPATH**/ ?>