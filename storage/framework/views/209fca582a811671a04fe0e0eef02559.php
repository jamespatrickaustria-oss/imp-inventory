                ...
                <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-dark-surface-secondary dark:border-dark-700">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-dark-surface-tertiary transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-x-3">
                                            ...
                                            <span class="text-sm font-medium text-gray-800 dark:text-gray-100"><?php echo e($user->name); ?></span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($user->created_at->format('M d, Y')); ?></span>
                                    </td>
                    ...
                    <div class="px-6 py-4 border-t border-gray-200 flex justify-between items-center dark:border-dark-700">
                        <span class="text-sm text-gray-600 dark:text-gray-400">
                            Showing <?php echo e($users->count()); ?> of <?php echo e($users->total()); ?> results
                        </span>
...
<?php /**PATH C:\Users\Dell\imp-inventory\resources\views/livewire/pages/admin/user-list.blade.php ENDPATH**/ ?>