    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
        <div class="mb-4 p-4 rounded-lg bg-red-50 border border-red-200 dark:bg-red-900/20 dark:border-red-800">
            <div class="flex items-center">
                ...
                <p class="font-medium text-sm text-red-800 dark:text-red-300"><?php echo e(session('error')); ?></p>
            </div>
        </div>
...
</div><?php /**PATH C:\Users\Dell\StockMaster-Pro\resources\views\livewire/pages/auth/forgot-password.blade.php ENDPATH**/ ?>