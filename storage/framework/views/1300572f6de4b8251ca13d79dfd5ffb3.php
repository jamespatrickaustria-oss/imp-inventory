...
>
    ...
    <div
        x-show="show"
        class="mb-6 bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full <?php echo e($maxWidth); ?> sm:mx-auto dark:bg-dark-surface-secondary dark:shadow-2xl"
        x-transition:enter="ease-out duration-300"
...
<?php /**PATH C:\Users\Dell\StockMaster-Pro\StockMaster-Pro\resources\views/components/modal.blade.php ENDPATH**/ ?>