...
<button @click="open = true"  class="py-2 px-5 inline-flex items-center text-sm font-bold rounded-xl border border-transparent bg-blue-600 text-white shadow-lg shadow-blue-200 hover:bg-blue-700 hover:shadow-none transition-all duration-200 transform active:scale-95">
      ...
      Add Category
          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-dark-700">
            <thead class="bg-gray-50 dark:bg-dark-surface-tertiary">
              <tr>
                ...
                <th scope="col" class="px-6 py-3 text-start"><span class="text-xs font-semibold uppercase tracking-wide text-gray-800 dark:text-gray-200">Visibility</span></th>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-dark-700">
              ...
              <tr class="hover:bg-gray-50 transition-colors dark:hover:bg-dark-surface-tertiary">
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center gap-x-2">
                    <div class="size-7 flex justify-center items-center bg-gray-100 rounded-md dark:bg-dark-surface-tertiary">
                      <svg class="size-4 text-gray-500 dark:text-gray-300" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>
                    </div>
                    <span class="text-sm font-medium text-gray-800 dark:text-gray-100"><?php echo e($category->name); ?> </span>
                  </div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap"><span class="text-xs font-mono text-gray-500 dark:text-gray-400"><?php echo e($category->slug); ?></span></td>
                <td class="px-6 py-4 whitespace-nowrap">
                  <span class="py-1 px-2 inline-flex items-center gap-x-1 text-xs font-medium bg-green-100 text-green-800 rounded-full dark:bg-emerald-500/20 dark:text-emerald-200">Published</span>
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                  <button type="button" class="text-blue-600 hover:text-blue-800 font-semibold px-2 dark:text-blue-400 dark:hover:text-blue-300">Edit</button>
                  <button type="button" class="text-red-600 hover:text-red-800 font-semibold px-2 dark:text-red-400 dark:hover:text-red-300">Delete</button>
                </td>
              </tr>
          ...
          <div class="px-6 py-4 border-t border-gray-200 flex justify-between items-center dark:border-dark-700">
            <span class="text-sm text-gray-600 dark:text-gray-400">12 categories total</span>
            <nav class="flex items-center -space-x-px">
              <button class="py-2 px-2.5 inline-flex justify-center items-center gap-x-1.5 text-sm font-medium rounded-s-lg border border-gray-200 bg-white text-gray-800 hover:bg-gray-50 dark:border-dark-600 dark:bg-dark-surface-tertiary dark:text-gray-100 dark:hover:bg-dark-surface-secondary">Previous</button>
              <button class="py-2 px-2.5 inline-flex justify-center items-center gap-x-1.5 text-sm font-medium rounded-e-lg border border-gray-200 bg-white text-gray-800 hover:bg-gray-50 dark:border-dark-600 dark:bg-dark-surface-tertiary dark:text-gray-100 dark:hover:bg-dark-surface-secondary">Next</button>
            </nav>
          </div>
        </div>
      </div>
  ...
  <div x-show="open" 
    ...
    <div @click.away="open = false" class="bg-white border shadow-sm rounded-xl w-full max-w-lg overflow-hidden transition-all dark:bg-dark-surface-secondary dark:border-dark-700">
      <div class="flex justify-between items-center py-3 px-4 border-b border-gray-200 bg-gray-50 dark:border-dark-700 dark:bg-dark-surface-tertiary">
        <h3 class="font-bold text-gray-800 dark:text-gray-100">Create New Category</h3>
      ...
      <div class="p-4 sm:p-6 overflow-y-auto">
        <form class="space-y-4">
          <div>
               <label class="block text-sm font-medium mb-2 text-gray-800 dark:text-gray-200">Category Name</label>
            <input type="text" 
          ...
          <div>
            <label class="block text-sm font-medium mb-2 text-gray-800 dark:text-gray-200">URL Slug</label>
            <div class="flex rounded-lg shadow-sm">
              ...
              <input type="text" class="py-2.5 px-4 block w-full border-gray-200 shadow-sm rounded-e-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:border-dark-600 dark:bg-dark-surface-tertiary dark:text-gray-100 dark:placeholder-gray-500 dark:focus:border-blue-400" placeholder="home-appliances">
            </div>
            <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">The "slug" is the URL-friendly version of the name.</p>
          </div>

          <div>
            <label class="block text-sm font-medium mb-2 text-gray-800 dark:text-gray-200">Visibility</label>
            <div class="flex gap-x-6">
              <div class="flex">
                <input type="radio" name="visibility" class="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 dark:border-dark-600" id="v-pub" checked>
                <label for="v-pub" class="text-sm text-gray-500 ms-2 dark:text-gray-300">Published</label>
              </div>
              <div class="flex">
                <input type="radio" name="visibility" class="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 dark:border-dark-600" id="v-hid">
                <label for="v-hid" class="text-sm text-gray-500 ms-2 dark:text-gray-300">Hidden</label>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <textarea class="py-2.5 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 shadow-sm dark:border-dark-600 dark:bg-dark-surface-tertiary dark:text-gray-100 dark:placeholder-gray-500 dark:focus:border-blue-400" rows="3" placeholder="Briefly describe the category..."></textarea>
          </div>
        </form>
      </div>
      ...
      <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t border-gray-200 bg-gray-50 dark:border-dark-700 dark:bg-dark-surface-tertiary">
        <button @click="open = false" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 dark:border-dark-600 dark:bg-dark-surface-secondary dark:text-gray-100 dark:hover:bg-dark-surface-tertiary">
          Cancel
        </button>
