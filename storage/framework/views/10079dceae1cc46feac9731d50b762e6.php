<section>
    <form wire:submit="updatePassword" class="space-y-6">
        <div>
            <label class="block text-sm font-bold text-gray-700 mb-1.5"><?php echo e(__('Current Password')); ?></label>
...
<?php endif; ?>
        ...
        <div>
            <label class="block text-sm font-bold text-gray-700 mb-1.5"><?php echo e(__('New Password')); ?></label>
...
<?php endif; ?>
        ...
        <div>
            <label class="block text-sm font-bold text-gray-700 mb-1.5"><?php echo e(__('Confirm Password')); ?></label>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.action-message','data' => ['class' => 'text-sm text-green-600 font-medium','on' => 'password-updated']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-sm text-green-600 font-medium','on' => 'password-updated']); ?>
...
</section><?php /**PATH C:\Users\Dell\StockMaster-Pro\StockMaster-Pro\resources\views\livewire\profile\update-password-form.blade.php ENDPATH**/ ?>