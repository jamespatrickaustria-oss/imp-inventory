        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Product')); ?></th>
                        <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Stock')); ?></th>
                        <th scope="col" class="px-6 py-3 text-end text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Status')); ?></th>
                    </tr>
                </thead>
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Name')); ?></th>
                        <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase"><?php echo e(__('Price')); ?></th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-200">
