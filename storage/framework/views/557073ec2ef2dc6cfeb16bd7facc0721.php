<section>
    <form wire:submit="updateProfileInformation" class="space-y-6">
        <div>
            <label class="block text-sm font-bold text-gray-700 mb-1.5"><?php echo e(__('Name')); ?></label>
...
<?php endif; ?>
        ...
        <div>
            <label class="block text-sm font-bold text-gray-700 mb-1.5"><?php echo e(__('Email')); ?></label>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.action-message','data' => ['class' => 'text-sm text-green-600 font-medium','on' => 'profile-updated']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-sm text-green-600 font-medium','on' => 'profile-updated']); ?>
...
</section><?php /**PATH C:\Users\Dell\StockMaster-Pro\StockMaster-Pro\resources\views\livewire\profile\update-profile-information-form.blade.php ENDPATH**/ ?>