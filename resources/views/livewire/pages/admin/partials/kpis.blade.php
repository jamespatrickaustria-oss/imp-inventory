<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6">
  ...
  <div class="group flex flex-col bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-md transition-all duration-300 dark:bg-dark-surface-secondary dark:border-dark-700">
    <div class="p-5">
      ...
      <div class="mt-3 flex items-end justify-between">
        <div>
          <h3 class="text-2xl font-bold text-gray-900 leading-none dark:text-gray-100">{{ $totoalProducts }}</h3>
  ...
  <div class="group flex flex-col bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-md transition-all duration-300 dark:bg-dark-surface-secondary dark:border-dark-700">
    <div class="p-5">
      ...
      <div class="mt-3">
        <h3 class="text-2xl font-bold text-gray-900 leading-none dark:text-gray-100">{{ $totalCategories }}</h3>
  ...
  <div class="group flex flex-col bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-md transition-all duration-300 dark:bg-dark-surface-secondary dark:border-dark-700">
    <div class="p-5">
      ...
      <div class="mt-3 flex items-end justify-between">
        <div>
          <h3 class="text-2xl font-bold text-gray-900 leading-none dark:text-gray-100">{{ $totalLowstock }}</h3>
  ...
  <div class="group flex flex-col bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-md transition-all duration-300 dark:bg-dark-surface-secondary dark:border-dark-700">
    <div class="p-5">
      ...
      <div class="mt-3">
        <h3 class="text-2xl font-bold text-gray-900 leading-none dark:text-gray-100">₱{{ number_format($getRevenue, 2) }}</h3>
