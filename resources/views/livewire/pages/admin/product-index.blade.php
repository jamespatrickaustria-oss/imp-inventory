                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-dark-700">
                            @forelse ($products as $product)
                                <tr class="hover:bg-gray-50 dark:hover:bg-dark-surface-tertiary transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="text-sm font-medium text-gray-800 dark:text-gray-100">{{ $product->category->name ?? 'N/A' }}</span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
            ...
            <form wire:submit="store" class="space-y-5 p-6 overflow-y-auto max-h-[70vh]">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input 
                            type="text" 
                            wire:model="name"
                            class="py-2.5 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 shadow-sm dark:border-dark-600 dark:bg-dark-surface-tertiary dark:text-gray-100 dark:focus:border-blue-400 @error('name') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input 
                            type="text" 
                            wire:model="sku"
                            class="py-2.5 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 shadow-sm dark:border-dark-600 dark:bg-dark-surface-tertiary dark:text-gray-100 dark:placeholder-gray-500 dark:focus:border-blue-400 @error('sku') border-red-500 @enderror" 
                            placeholder="PRD-001">
                ...
                <div>
                    ...
                    <select 
                        ...
                        class="py-2.5 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 shadow-sm dark:border-dark-600 dark:bg-dark-surface-tertiary dark:text-gray-100 @error('category_id') border-red-500 @enderror">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div>
                        ...
                        <input 
                            ...
                            step="0.01" 
                            wire:model="price"
                            class="py-2.5 px-4 block w-full border-gray-200 rounded-lg text-sm focus:ring-blue-500 shadow-sm dark:border-dark-600 dark:bg-dark-surface-tertiary dark:text-gray-100 @error('price') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input 
                            type="number" 
                            wire:model="quantity"
                            class="py-2.5 px-4 block w-full border-gray-200 rounded-lg text-sm focus:ring-blue-500 shadow-sm dark:border-dark-600 dark:bg-dark-surface-tertiary dark:text-gray-100 @error('quantity') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            class="py-2.5 px-4 block w-full border-gray-200 rounded-lg text-sm focus:ring-blue-500 shadow-sm dark:border-dark-600 dark:bg-dark-surface-tertiary dark:text-gray-100 @error('min_stock') border-red-500 @enderror">
